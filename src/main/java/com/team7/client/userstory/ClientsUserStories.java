...
public class ClientsUserStories {
    ...
    public static void checkUserStory8() {
        ...
        try {
            ...
            if (!cart.getItems().isEmpty()) {
                ...
                System.out.println("Количество изменено: " + cart.getItems().getFirst().getQuantity());
    ...
    private static void addItemsToCart(Long userId) {
        com.team7.client.service.CartService cartService = new com.team7.client.service.CartServiceImpl();
    ...
    public static void checkUserStory15() {
        ...
        try {
            addTestRestaurants((RestaurantServiceImpl) restaurantService);
    ...
    private static void addTestRestaurants(RestaurantServiceImpl restaurantService) {
        // Ресторан 1
        ...
        restaurantService.addRestaurant(pizzaRestaurant);
        ...
        restaurantService.addRestaurant(burgerRestaurant);
